...
class Predio(db.Model):
    ...
    id_persona = db.Column(db.Integer, db.ForeignKey('persona.persona_id'))
    ...
    def __init__(self, id_predio, id_tipo_predio, descripcion, ruc, telefono, correo, direccion, idubigeo, id_persona, url_imagen):
    ...
    def __init__(self, id_predio, idubigeo, departamento):
        self.id_predio = id_predio
        self.idubigeo = idubigeo
        self.departamento = departamento

    def __init__(self, id_predio, persona_id, persona_dni):
        self.id_predio = id_predio
